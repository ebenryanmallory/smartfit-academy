...
export function relevanceEngineInstructions(educationLevel: EducationLevel): string {
...
- Descriptions should explain what historical knowledge or classical wisdom \${config.audience} will learn (minimum 20 characters)`
    ...
    .replace(
      ...
      `- Include both historical understanding and philosophical insights suitable for \${educationLevel} students
...
- Focus on teaching about the past rather than directly addressing modern topics`
    ...
    .replace(
      ...
      `HISTORICAL CONTENT FOCUS FOR \${educationLevel.toUpperCase()} LEVEL:
