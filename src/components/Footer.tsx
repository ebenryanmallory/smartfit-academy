    ...
    <footer className={`border-t ${isDashboardPage ? 'pb-48' : ''}`}>
      <div className="content-container mx-auto px-4 py-4 text-center text-gray-600 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <img src="/smartfit.svg" alt="Good Feed" className="h-8 w-auto" />
          <span>© {new Date().getFullYear()} Good Feed</span>
        </div>
        <div className="flex gap-4">
          ...
          <Link to="/privacy" className="focus-visible:ring-1 focus-visible:ring-ring hover:underline inline-flex items-center justify-center px-4 py-2 rounded-md text-primary text-sm transition-colors underline-offset-4 whitespace-nowrap">Privacy</Link>
